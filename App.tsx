    ...
    <NavigationContainer>
      <SafeAreaProvider>
        ...
        >
          ...
          <AppStack.Screen name="Single Document" component={SingleDocument} />
          <AppStack.Screen name="Jobs" component={Jobs} />
          <AppStack.Screen name="Single Job" component={SingleJob} />

          <AppStack.Screen name="ApplyNow" component={ApplyNow} />
        </AppStack.Navigator>
      </SafeAreaProvider>
    </NavigationContainer>
  );
